...
let city = "vienna";
let units = "metric";
let apiKey = "bc21775749a463dd976c3ae303c75079";
...
//event.preventDefault();
//let temperatureLink = document.querySelector("#temperature");
//temperatureLink.innerHTML = 22;
//}

//let linkFarenheit = document.querySelector("#farenheit-link");
//linkFarenheit.addEventListener("click", changeToFarenheit);

//let linkCelsius = document.querySelector("#celsius-link");
//linkCelsius.addEventListener("click", changeToCelsius);
